...
import { LogOut, BookOpen, Users, Menu, X, User as UserIcon, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-stone-50 flex flex-col" dir="rtl">
      <header className="bg-white/80 backdrop-blur-md border-b border-stone-200 shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-10">
              <Link to="/courses" className="flex items-center gap-3 group transition-transform hover:scale-105">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-[10px] text-amber-600 font-bold tracking-widest uppercase mt-1">للعلوم والتدريب</span>
                </div>
              </Link>
            ...
            <div className="flex items-center gap-4">
              <div className="hidden sm:flex items-center gap-3 px-4 py-2 bg-stone-50 border border-stone-100 rounded-2xl">
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-stone-100 shadow-2xl animate-in slide-in-from-top-4 duration-300">
            <div className="p-6 space-y-4">
              <div className="flex items-center gap-4 p-4 bg-stone-50 rounded-2xl border border-stone-100 sm:hidden">
                ...
                <div>
                  <p className="text-base font-black text-stone-800">{user?.full_name}</p>
